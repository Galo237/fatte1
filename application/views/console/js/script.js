...
document.addEventListener("DOMContentLoaded", function() {
  ...
  const steps = [
      {
          message: "Olá, como posso ajudá-lo(a) hoje?<br>1. Realização do Pagamento<br>2. Carrinho de compras<br>3. Disponibilidade de produtos<br>4. Realização de cadastro ou login<br>5. Nenhuma das dúvidas acima.",
          options: {
              '1': 1,
              '2': 2,
              '3': 3,
