...
$sql = "SELECT * FROM produtos WHERE proGenero = 'M' AND proNome LIKE '%$search%'";
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-custom">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <form class="form-inline my-2 my-lg-0" method="post" action="masculino.php">
    ...
    <h3 style="margin-top: 50px; text-align: center">Catálogo Masculino</h3>
